...
export default function MainBtn({ title, handleClickEvent }: MainBtnProps) {
  return (
    <button
      ...
      className="group flex items-center justify-center  bg-primary text-text capitalize text-sm font-bold px-[30px] h-[40px] duration-300 hover:text-primary hover:bg-primary hover:shadow-shadow relative before:absolute before:inset-[2px] before:bg-main-bg  overflow-hidden rounded-sm"
    >
